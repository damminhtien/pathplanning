...
def sampleFree(initparams, bias=0.1, max_tries=1000):
    """biased sampling with bounded resampling."""
...
def path(initparams, Path=None, dist=0):
    if Path is None:
        Path = []
    x = initparams.xt
