...
_ALGORITHMS: List[AlgorithmSpec] = [
    ...
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.Astar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.bidirectional_Astar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.LP_Astar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.LRT_Astar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.RTA_Astar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        "search3d.dstar",
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.Dstar3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        "search3d.dstar_lite",
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.DstarLite3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "search",
        "3d",
        "pathplanning.search_based_planning.Search_3D.Anytime_Dstar3D",
        SUPPORTED,
    ),
    # Sampling 2D
    AlgorithmSpec(
    ...
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.rrt3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.rrt_connect3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.extend_rrt3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.dynamic_rrt3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        "sampling3d.rrt_star",
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.rrt_star3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.informed_rrt_star3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.rrt_star_smart3D",
        DROPPED_INCOMPLETE,
        reason="Module is empty and does not expose a planner entry point.",
    ),
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.FMT_star3D",
        SUPPORTED,
    ),
    AlgorithmSpec(
        "sampling3d.bit_star",
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.BIT_star3D",
        SUPPORTED,
    ),
    ...
    AlgorithmSpec(
        ...
        "sampling",
        "3d",
        "pathplanning.sampling_based_planning.rrt_3D.ABIT_star3D",
        DROPPED_INCOMPLETE,
