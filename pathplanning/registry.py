...
_EXPECTED_ENTRYPOINTS: Dict[str, str] = {
    ...
    "sampling3d.bit_star": "BitStar",
    "sampling3d.dynamic_rrt": "DynamicRRT3D",
    "sampling3d.extended_rrt": "ExtendRrt",
    "sampling3d.fmt_star": "FmtStar",
    "sampling3d.informed_rrt_star": "InformedRrtStar",
    "sampling3d.rrt": "RrtPlanner",
    "sampling3d.rrt_connect": "RrtConnect",
